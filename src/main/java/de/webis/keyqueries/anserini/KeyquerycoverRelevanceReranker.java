...
import de.webis.keyqueries.KeyQueryCoverSolver;
...
public class KeyquerycoverRelevanceReranker<T> implements Reranker<T>, RelevanceFeedbackAware<T> {
	...
	public ScoredDocuments rerank(ScoredDocuments docs, RerankerContext<T> context) {
		...
		List<String> keyquerycover = KeyQueryCoverSolver.getKeyQueryCover(keyqueries, checker);
		for(String query: keyquerycover) {
